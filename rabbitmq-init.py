...
def setup_rabbitmq():
    ...
    queues_bindings = [
        {'queue': os.getenv('RABBITMQ_QUEUE_PERSON_FINDER'), 'routing_key': os.getenv('RABBITMQ_ROUTING_KEY_PERSON_FINDER')},
        {'queue': os.getenv('RABBITMQ_QUEUE_INTIAL'), 'routing_key': os.getenv('RABBITMQ_ROUTING_KEY_INTIAL')},
